# This script pulls real time JSON data from the Coin Market Cap global API and displays the results in the console.
...
# This line specifies the currency to display the results
...
print()
print('There are a total of ' + active_currencies_string + ' active cryptocurrencies in ' + active_markets_string + ' active markets.')
print('The global market cap of all cryptocurrencies is ' + '$' + global_cap_string + '.')
